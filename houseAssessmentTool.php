...
<!-- -->
    ...
    <body id="houseAssessment-background">
    <div class="card">
        <container class="container">
            ...
            -->
            <h1 class="text-center" id="form-title">House Assessment Form</h1>
            ...
            <div class ="inputparam text-center">
                <label for="layout">Home Layout <span class="required">*</span>
                    <a href="https://www.assess.co.polk.ia.us/cgi-bin/web/tt/infoqry.cgi?tt=home/index" target="_blank" id="assessor-link">Polk County</a>
                    <a href="https://jasper.iowaassessors.com/search.php" target="_blank" id="assessor-link">Jasper County</a>
                    <a href="https://beacon.schneidercorp.com/Application.aspx?AppID=909&LayerID=17429&PageTypeID=2&PageID=7823" target="_blank" id="assessor-link">Dallas County</a>
                </label> 
                <div class ="box">
                <br>
            ...
            <div class ="inputparam text-center">
                <div class ="box">
                <button id="form-submit" type="submit" name="submit">Submit Assessment</button>
                </div>
            </div>
            </form>
            <div id="output"></div>
